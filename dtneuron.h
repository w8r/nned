 ...
 *
 *  нейрон динамического отслеживания, его функция - в обработке менее
 *  явных участков контура, связанных с "первичными" участками, но не 
 *  прешедших проверки на первой стадии распознавания
 *
 */
